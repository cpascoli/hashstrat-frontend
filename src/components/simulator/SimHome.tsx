...
import { TimeSeriesAreaChart } from "../invest/pool/TimeSeriesAreaChart"


import { DepositToken, InvestTokens } from "../../utils/pools"
import { TimeSeriesLineChart, TimeSeriesData } from "../../components/invest/pool/TimeSeriesLineChart"
...
export const SimHome = ({ chainId } : SimHomeProps) => {
    ...
    const [fromDate, setFromDate] = useState<Date>(new Date('2019-01-01T00:00:00')) //'2018-01-01T00:00:00'
    const [toDate, setToDate] = useState<Date>(new Date())
    const [asset, setAsset] = useState<string>("WBTC")
    const [strategy, setStrategy] = useState<string>(StrategyName[StrategyName.Rebalancing])

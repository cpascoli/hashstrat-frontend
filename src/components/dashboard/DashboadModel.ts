...
export const useDashboardModel = (chainId: number, tokens: Token[], depositToken: Token, account?: string) : DashboadModel => {
    ...
    return  {
        ...
        chartValueByAsset: { title: "Asset Value Chart", data: valueByAsset, width: 250, height: 250, includePercent: true},
        chartValueByPool: { title: "Pool Value Chart", data: valueByPool, width: 250, height: 250, includePercent: false},
        poolsInfo,
        indexesInfo,
    }

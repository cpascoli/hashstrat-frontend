           ...
           <Accordion>
                ...
                <AccordionDetails >
                    <Typography variant="body2" >
                        ...
                        Users deposit capital, in the form of stable crypto-assets (USDC), into Pools to be invested by on-chain strategies.
                        <br/>
                        When users deposit funds into a Pool, they receive "PoolLP tokens" that represent ownership of their share of the Pool.<br/>
                        Users can "stake" their PoolLP tokens to farm (aka earn) HST tokens that allow to participate in the protocol gorvernance and revenue 
                        sharing programs.<br/>
            ...
            <Accordion>
                <AccordionSummary expandIcon={<ExpandMore />} aria-controls="panel1bh-content" >
                    <Typography style={{fontSize: 20, fontWeight: 400}} > Why self-sovereign crypto-funds on the blockchain? </Typography>
                </AccordionSummary>
                <AccordionDetails >
                    <Box>
                        ...
                        <ul>
                            ...
                            <li>Users stay in control of their funds at all times </li>
                            <li>No barrier to entry</li>
                            <li>No minimum investing requirements </li>
                            <li>No gatekeepers</li>
                            <li>No need to ask someone to get your mney back.</li>
                        ...
                        Additionally, HashStrat can help to avoid loosing money solo trading.  <br/>
            ...
            <Accordion>
                ...
                <AccordionDetails >
                    <Typography variant="body2">
                        The HashStrat protocol generaets revenues by taxing profits that are withdrawn from the HashStrat Pools &amp; Indexes. <br/>
                        The profit withdrawl fee is currently set to 1% of profits.<br/>
                        Fees stay within the pool and soon, DAO memebers will be able to decide their destination.<br/>
                        Possible uses include distibution among the DAO token holders or allocation to the marketing and development budgets.
                    </Typography> 
                </AccordionDetails>
            </Accordion>
            ...
            <Accordion>
                <AccordionSummary expandIcon={<ExpandMore />} aria-controls="panel1bh-content" >
                    <Typography style={{fontSize: 20, fontWeight: 400}} > What are the risks?</Typography>
                </AccordionSummary>
                <AccordionDetails >
                    <Box>
